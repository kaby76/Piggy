...
AST commonly used in ClangSharp and CppSharp, but abstracts the visitor code into templates.
...
The advantage of this approach is for developers to easily customize the translation of
