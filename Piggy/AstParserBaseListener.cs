...
/// <summary>
/// This class provides an empty implementation of <see cref="IAstParserListener"/>,
/// which can be extended to create a listener which only needs to handle a subset
/// of the available methods.
/// </summary>
[System.CodeDom.Compiler.GeneratedCode("ANTLR", "4.7.1")]
[System.CLSCompliant(false)]
public partial class AstParserBaseListener : IAstParserListener {
	/// <summary>
	/// Enter a parse tree produced by <see cref="AstParserParser.ast"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterAst([NotNull] AstParserParser.AstContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="AstParserParser.ast"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitAst([NotNull] AstParserParser.AstContext context) { }
	/// <summary>
	/// Enter a parse tree produced by <see cref="AstParserParser.decl"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterDecl([NotNull] AstParserParser.DeclContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterAttr([NotNull] AstParserParser.AttrContext context) { }
	/// <summary>
